...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCI14\\SQL2017;DataBase=CI_PLATFORM;User ID=sa;Password=Tatva@123;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA414135529120");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C346A15F0CA");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8982138C0");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B527B3C1E30");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7957687CF460A07");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD05563B47521");
        ...
        {
            entity.HasKey(e => e.FavoriteMissionId).HasName("PK__favorite__B4CF3312006FA2E3");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7F1264800");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB280AD11E0");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A54618752");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC85B37D39D");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158605EE333");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8A692EC78");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E5172822ACB2E");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008FE23EA51");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACF9715961");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA83793A02B853");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C5610BC3524");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Stories)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story__user_id__4E53A1AA");
        });

        modelBuilder.Entity<StoryInvite>(entity =>
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__0449786740AA103C");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C79EBCE16");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068C080E383");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370FB5478706");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B83BBBE4C");
